...
Usage:
    docker cp parser/colmi/scripts/clear_checkpoint.py biomarker-parser-colmi:/tmp/clear_checkpoint.py
    docker exec -it biomarker-parser-colmi python3 /tmp/clear_checkpoint.py
